    ...
    <div className="container mt-md-5 mt-3 mb-7">
      <div className="row">
        <div className="col-md-2">
          <ProductsCategorySidebar activeAccordion="two" />
        </div>
